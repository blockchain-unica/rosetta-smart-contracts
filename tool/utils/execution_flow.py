...
def deploy(chain_cost_data,contractInfo, account, value, *contract_args):
    w3 = chain_cost_data[0]
    coinPrice= chain_cost_data[1]
    chainID= chain_cost_data[2]
    gasprice=  chain_cost_data[3]
    ...
    """
    tx_receipt, contract = deployer.deploy_sc(w3, contractInfo, account, value, chainID, current_nonce(account.address,w3), *contract_args)
