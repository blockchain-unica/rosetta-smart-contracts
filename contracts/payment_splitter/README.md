...
- **Leo/Aleo**: implementation coherent with the specification, with the maximum number of shareholders fixed to 10 at compile time, since Leo does not support dynamic arrays or loops with runtime bounds.