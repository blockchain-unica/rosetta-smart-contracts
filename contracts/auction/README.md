...
- **Vyper/Ethereum**: implementation is similar to Solidity, but rebidding requires a manual withdrawal step. This is because Vyper does not allow calling external functions from within the contract.
